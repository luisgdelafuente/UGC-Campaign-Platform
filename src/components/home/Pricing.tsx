    ...
    <Section
      ...
      <div className="mt-12 grid grid-cols-1 items-stretch gap-6 lg:grid-cols-3">
        ...
        <article
          ...
          tier.featured ?
          'border border-hairline bg-inverse text-onInverse' :
          'border border-hairline bg-canvas'}`
            ...
            <div className="flex items-center justify-between">
              ...
              tier.featured ? 'text-accent-bright' : 'text-faint'}`
              }>
              
                {tier.name}
              </h3>
              {tier.featured &&
            <span className="rounded-full bg-accent-bright px-2.5 py-1 text-[11px] font-semibold text-[#0B0B0B]">
                  {copy.mostChosen}
                </span>
            }
            </div>
            ...
            <p className="mt-6 flex items-baseline gap-2">
              ...
              tier.featured ? 'text-onInverse' : 'text-ink'}`
              }>
              ...
              <span
              className={`text-[13px] ${
              tier.featured ? 'text-onInverse/60' : 'text-subtle'}`
              }>
            ...
            tier.featured ? 'text-onInverse/70' : 'text-muted'}`
            }>
            ...
            <li
              ...
              tier.featured ? 'text-onInverse/85' : 'text-body'}`
              }>
